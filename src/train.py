...
if __name__ == '__main__':
    ...
    # -model_path ../models/bert_classifier -lr 2e-3 -visible_gpus 0,1,2  
    # -gpu_ranks 0,1,2 -world_size 3 -report_every 50 
    # -save_checkpoint_steps 1000 -batch_size 3000 -decay_method noam 
    # -train_steps 50000 -accum_count 2 
    # -log_file ../logs/bert_classifier -use_interval true -warmup_steps 10000
    ...
    parser.add_argument("-bert_data_path", default='/home/wjm/hrx/BertSum_cnndm/bert_data/cnndm')
    parser.add_argument("-model_path", default='/home/wjm/hrx/BertSum_cnndm/models/bert_classifier_5000')
    parser.add_argument("-result_path", default='/home/wjm/hrx/BertSum_cnndm/results/cnndm_classifier')
    parser.add_argument("-temp_dir", default='../temp')
    parser.add_argument("-bert_config_path", default='/home/wjm/hrx/BertSum_cnndm/bert_config_uncased_base.json')
   ...
   # parser.add_argument('-log_file', default='../logs/bert_transformer_train_chinese')
    parser.add_argument('-log_file', default='/home/wjm/hrx/BertSum_cnndm/logs/bert_classifier-5000')
    parser.add_argument('-dataset', default='')
    parser.add_argument('-seed', default=666, type=int)

    parser.add_argument("-test_all", type=bool, default=False)
    # parser.add_argument("-test_all", type=str2bool, nargs='?',const=True, default=False)
    parser.add_argument("-test_from", default='/home/wjm/hrx/BertSum_cnndm/models/bert_classifier_5000/model_step_5000.pt')
